...
class Schema {
    ...
    public static function install(): void {
        ...
        $sql_quote = "CREATE TABLE $t_quote (
            ...
            ricevuta_numero SMALLINT UNSIGNED NULL DEFAULT NULL,
            verbale_data DATE NULL DEFAULT NULL,
            pagatore_nome VARCHAR(190) NULL DEFAULT NULL,
            pagatore_sede VARCHAR(255) NULL DEFAULT NULL,
            pagatore_cf VARCHAR(30) NULL DEFAULT NULL,
            pagatore_piva VARCHAR(20) NULL DEFAULT NULL,
            note TEXT NULL,
            created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
            created_by BIGINT UNSIGNED NULL DEFAULT NULL,
            PRIMARY KEY  (id),
            UNIQUE KEY uniq_user_anno (user_id, anno),
            KEY ricevuta_anno (anno, ricevuta_numero),
            KEY anno (anno),
            KEY stato (stato),
