...
class Admin {
    ...
    public static function menu(): void {
        ...
        add_submenu_page( 'gfoss-associazione', __( 'Registro volontari', 'gfoss-members' ), __( 'Registro volontari', 'gfoss-members' ), Roles::CAP_MANAGE_VOLONTARI, 'gfoss-volontari',        [ __CLASS__, 'view_volontari' ] );
    ...
    public static function view_volontari(): void   { self::render( 'volontari' ); }
